...
export interface ApiDepartamentoDepartamento extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    departamentoName: Attribute.String;
    mainImage: Attribute.Media<'images'>;
    publishedAt: Attribute.DateTime;
    slug: Attribute.UID;
    updatedAt: Attribute.DateTime;
...
export interface ApiGeneroGenero extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    mainImage: Attribute.Media<'images'>;
    nameGenero: Attribute.String;
    publishedAt: Attribute.DateTime;
    slug: Attribute.UID<'api::genero.genero', 'nameGenero'>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::genero.genero',
      'oneToOne',
...
export interface ApiMarcaMarca extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    mainImage: Attribute.Media<'images'>;
    nameMarca: Attribute.String;
    publishedAt: Attribute.DateTime;
    slug: Attribute.UID<'api::marca.marca', 'nameMarca'>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::marca.marca',
      'oneToOne',
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    estilo: Attribute.Enumeration<['Alambrismo', 'Tejido', 'Playero']>;
    genero: Attribute.Relation<
      'api::product.product',
      'oneToOne',
      'api::genero.genero'
    >;
    ...
    tipo: Attribute.Enumeration<['Individual', 'Pack']>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::product.product',
      'oneToOne',
